  ...
  template: `
    <div class="bg-cream min-h-screen">
      ...
      <nav class="md:hidden bg-white border-b border-cream-dark px-4 py-2 flex gap-1 overflow-x-auto">
        <a routerLink="/admin" class="flex-shrink-0 flex items-center gap-1.5 px-3 py-2 font-body text-[11px] font-semibold uppercase tracking-wide bg-cream text-plum rounded">
          📊 Overview
        </a>
