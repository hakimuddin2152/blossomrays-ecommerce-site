...
const benefits = [
  {
    titleKey: 'home.benefits.delivery.title',
    descKey: 'home.benefits.delivery.desc',
    accent: '#C49A6C',
  ...
  {
    titleKey: 'home.benefits.guarantee.title',
    descKey: 'home.benefits.guarantee.desc',
    accent: '#6B8F61',
  ...
  },
  {
    ...
    descKey: 'home.benefits.support.desc',
    accent: '#8B89C8',
      ...
      <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-cream-dark">
        ...
        >
          ...
          <div class="space-y-0.5">
            ...
            <p class="font-body text-[12px] text-muted leading-relaxed">{{ t(b.descKey) }}</p>
          </div>
        </div>
      </div>
    </section>
